...
const countryData = [
    ...
    { "name": "Clipperton Island", "code": "CP", "emoji": "🇨🇵" },
    ...
    { "name": "Diego Garcia", "code": "DG", "emoji": "🇩🇬" },
    ...
    { "name": "Ceuta & Melilla", "code": "EA", "emoji": "🇪🇦" },
    ...
    { "name": "European Union", "code": "EU", "emoji": "🇪🇺" },
    ...
    { "name": "Hong Kong SAR China", "code": "HK", "emoji": "🇭🇰" },
    ...
    { "name": "Canary Islands", "code": "IC", "emoji": "🇮🇨" },
    ...
    { "name": "Macao SAR China", "code": "MO", "emoji": "🇲🇴" },
    ...
    { "name": "Palestinian Territories", "code": "PS", "emoji": "🇵🇸" },
    ...
    { "name": "Tristan da Cunha", "code": "TA", "emoji": "🇹🇦" },
        ...
        <View style={styles.container}>
            <TouchableOpacity style={styles.input} onPress={() => setModalVisible(true)}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    {selectedCountry && <Text style={styles.flag}>{selectedCountry.emoji}</Text>}
